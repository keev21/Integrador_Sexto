...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-07-2024 a las 21:41:43
...
(1, 'Procesadores', 'Componentes que procesan datos en una computadora.', 'Publicar'),
(2, 'Tarjetas gráficas', 'Componentes que procesan imágenes en una computadora.', 'Publicar'),
(3, 'Memoria RAM', 'Componentes que almacenan datos temporalmente para acceso rápido.', 'Publicar'),
(4, 'Almacenamiento', 'Dispositivos de almacenamiento de datos en una computadora.', 'Publicar'),
(5, 'Placas base', 'Componente principal de una computadora que conecta todos los demás componentes.', 'Publicar');
...
(12, 'kevinsan16@gmail.com', '$2y$10$Hn48lYQKERK7c8mVoHMckeih5O7AXGESlvm2TvnIiO63buKxwzWHC', 'David Lopez', 'Riobamba', 'Ecuador', 'Olmedo y Quito', '0987654321');
...
(1, 1, 350.00, 'ServiEntrega', 'Av. Principal #123, Quito, Ecuador', '2024-01-18 00:00:00', 'Enviado'),
(2, 2, 500.00, 'ServiEntrega', 'Calle Principal #456, Guayaquil, Ecuador', '2024-01-19 00:00:00', 'Enviado'),
(3, 3, 200.00, 'ServiEntrega', 'Av. Central #789, Cuenca, Ecuador', '2024-02-03 00:00:00', 'Enviado'),
(4, 4, 750.00, 'ServiEntrega', 'Calle Secundaria #1011, Machala, Ecuador', '2024-02-21 00:00:00', 'Enviado'),
(5, 5, 400.00, 'ServiEntrega', 'Av. Norte #1213, Santo Domingo, Ecuador', '2024-03-01 00:00:00', 'Enviado'),
(6, 6, 600.00, 'ServiEntrega', 'Calle Este #1415, Portoviejo, Ecuador', '2024-03-15 00:00:00', 'Enviado'),
(7, 7, 300.00, 'ServiEntrega', 'Av. Sur #1617, Ambato, Ecuador', '2024-03-24 00:00:00', 'Enviado'),
(8, 12, 297.00, 'ServiEntrega', 'Olmedo y Quito', '2024-04-04 03:48:46', 'Enviado');
...
(1, 'REF001', 'Procesador Intel Core i7', 225.00, 'Potente procesador para computadoras de alto rendimiento.', '../../Public/assets/images/productsinteli7.png', 1, '2024-01-05 00:00:00', 3, 1, 10),
(2, 'REF002', 'Tarjeta gráfica NVIDIA GeForce RTX 3080', 630.00, 'Potente tarjeta gráfica para juegos y diseño.', '../../Public/assets/images/products5974.jpg.jpg', 2, '2024-01-06 00:00:00', 6, 1, 10),
(3, 'REF003', 'Memoria RAM Corsair Vengeance LPX 16GB', 72.00, 'Módulo de memoria RAM de alta velocidad para mejorar el rendimiento del sistema.', '../../Public/assets/images/productsram.png', 3, '2024-01-07 00:00:00', 4, 1, 10),
(4, 'REF004', 'SSD Samsung 1TB', 108.00, 'Unidad de estado sólido de alta capacidad para almacenamiento rápido.', '../../Public/assets/images/productsssd.png', 4, '2024-01-08 00:00:00', 7, 1, 10),
(5, 'REF005', 'Placa base ASUS ROG Strix Z590-E Gaming', 300.00, 'Placa base de alta gama con características avanzadas para entusiastas.', '../../Public/assets/images/productsasus.png', 5, '2024-01-09 00:00:00', 3, 1, 0),
(6, 'REF006', 'Procesador AMD Ryzen 9 5900X', 450.00, 'Potente procesador de la serie Ryzen para computadoras de alto rendimiento.', '../../Public/assets/images/productsamd.png', 1, '2024-01-10 00:00:00', 5, 2, 0),
(7, 'REF007', 'Tarjeta gráfica AMD Radeon RX 6800 XT', 650.00, 'Tarjeta gráfica de AMD para juegos de última generación y renderizado.', '../../Public/assets/images/productsamd2.png', 2, '2024-01-11 00:00:00', 4, 2, 0),
(8, 'REF008', 'Memoria RAM G.Skill Trident Z RGB 32GB', 150.00, 'Módulo de memoria RAM con iluminación RGB para personalizar el aspecto de tu PC.', '../../Public/assets/images/productsram2.png', 3, '2024-01-12 00:00:00', 6, 2, 0),
(9, 'REF009', 'SSD NVMe Western Digital Black SN850 500GB', 100.00, 'Unidad SSD NVMe ultrarrápida para cargas y transferencias de datos rápidas.', '../../Public/assets/images/productsssd2.png', 4, '2024-01-13 00:00:00', 2, 2, 0),
(10, 'REF010', 'Placa base MSI MPG B550 Gaming Edge WiFi', 200.00, 'Placa base con conectividad WiFi y características para juegos.', '../../Public/assets/images/productsboard.png', 5, '2024-01-14 00:00:00', 5, 2, 0);
...
(8, '7VK958518F3144601', '2024-04-04 03:48:46', 'COMPLETED', 'sb-89yap29242640@personal.example.com', 12, 297);
...
(2, '0604899732', 'Rafael', 'Sanchez', '0998272313', 'keevsanchez37@gmail.com', '202cb962ac59075b964b07152d234b70', 'Empleado');
...
--
ALTER TABLE `carrito_compras`
  MODIFY `carritoID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `ordendetalle`
  MODIFY `OrdenDetalleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `ordenes`
--
ALTER TABLE `ordenes`
  MODIFY `OrdenID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
